...
#define GPU_LOOP_LTOP MY_PRAGMA(acc parallel loop gang worker vector)
#define GPU_LOOP_LBOT MY_PRAGMA()
#define GPU_LOOP_LBOT_REDUCTION(x ...) MY_PRAGMA() 
//#define OMP_L0 MY_PRAGMA()
#define DECLARE_TARGET     MY_PRAGMA(acc routine seq)
#define DECLARE_TARGET_END MY_PRAGMA()
#define DECLARE_TARGET_LTOP     MY_PRAGMA(acc routine seq)
#define DECLARE_TARGET_LTOP_END MY_PRAGMA()
